    ...
    <div className="px-6 py-5 border-b border-neutral-200">
      ...
      <div className="flex items-baseline justify-between">
        ...
        <div className="flex items-center gap-2">
          {state === 'loading' && (
            <span className="font-mono text-[8px] text-neutral-400 uppercase tracking-wider animate-pulse">
              Analyzing...
            </span>
          )}
      ...
      {narrative && (
        <p className="font-mono text-[11px] text-neutral-500 mt-3 leading-relaxed">
          {narrative}
        </p>
      )}
