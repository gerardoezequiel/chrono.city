...
function buildStyle(): maplibregl.StyleSpecification {
  return {
    ...
    layers: [
      ...
      // Land cover from Overture base — muted earth tones, z2-12
      {
        id: 'land-cover-fill',
        type: 'fill',
        source: 'base',
      ...
      // Land use zones from Overture base — building-related subtypes at z6-13
      {
        id: 'land-use-fill',
        type: 'fill',
        source: 'base',
        ...
        filter: ['match', ['get', 'subtype'],
          ['residential', 'developed', 'education', 'medical', 'entertainment', 'religious', 'construction'],
          true, false,
        ],
        paint: {
          'fill-color': ['match', ['get', 'subtype'],
